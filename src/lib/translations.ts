...
export const translations = {
  'Bahasa Indonesia': {
    ...
    today: 'Hari Ini',
    totalWordsInBank: 'Total Kata di Word Bank',
    ...
    create: 'Buat',
    moveSuccess: 'Berhasil memindahkan',
    ...
    clearConfirm: 'Apakah Anda yakin ingin menghapus semua teks?',
    wordDetails: 'Detail Kata',
    term: 'Kata',
    definition: 'Arti',
    saveToWordList: 'Simpan ke Word List',
    saved: 'Tersimpan!',
    close: 'Tutup',
    learningHistory: 'Riwayat Belajar',
    deleteHistoryConfirm: 'Apakah Anda yakin ingin menghapus riwayat ini?',
    processingWithAI: 'Memproses dengan AI...',
    wordNotFound: 'Arti kata tidak ditemukan',
    loadingDefinition: 'Arti kata akan muncul di sini...',
    loadingExample: 'Contoh kalimat dari AI akan muncul di sini.',
    wordAlreadyExists: 'Kata',
  ...
  'English': {
    ...
    today: 'Today',
    totalWordsInBank: 'Total Words in Bank',
    ...
    saveToWordList: 'Save to Word List',
    saved: 'Saved!',
    close: 'Close',
    learningHistory: 'Learning History',
    deleteHistoryConfirm: 'Are you sure you want to delete this history?',
    processingWithAI: 'Processing with AI...',
    wordNotFound: 'Word meaning not found',
    loadingDefinition: 'Word definition will appear here...',
    loadingExample: 'Example sentence from AI will appear here.',
...
export const t = (key: string, lang: string = 'Bahasa Indonesia'): string => {
  const langKey = lang === 'Bahasa Indonesia' ? 'Bahasa Indonesia' : 'English';
  const keys = key.split('.');
  const translationsForLang = translations[langKey as keyof typeof translations];
...
export const translatePartOfSpeech = (pos: string, lang: string): string => {
  ...
  for (const [english, indonesian] of Object.entries(posMap)) {
    if (english.toLowerCase() === lowerPos) {
      return indonesian;
    }
  }
